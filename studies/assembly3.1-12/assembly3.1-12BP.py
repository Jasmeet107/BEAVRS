...
importxsFromCasmo('pwru310w12','8-group/')
...
log.py_printf('TITLE', 'Simulating the BEAVRS 3.1 pct enriched 12 BP assembly...')
  
group = '8'
assembly = CellFill(universe=0, universe_fill= lattices[group]['3.1-12BP'].getId())
