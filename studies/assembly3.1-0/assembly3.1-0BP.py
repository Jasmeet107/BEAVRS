...
importxsFromCasmo('pwru310c00','8-group/')
...
log.py_printf('TITLE', 'Simulating the BEAVRS 3.1 pct enriched 0 BP assembly...')
  
group = '8'
assembly = CellFill(universe=0, universe_fill= lattices[group]['3.1-0BP'].getId())
...
for material in materialtypes:
  geometry.addMaterial(materials[group]['pwru310c00'][material])
...
#add cells
geometry.addCell(pincells[group]['pwru310c00']['fuel'])
geometry.addCell(pincells[group]['pwru310c00']['cladding'])
geometry.addCell(pincells[group]['pwru310c00']['water'])
geometry.addCell(pincells[group]['pwru310c00']['helium'])
geometry.addCell(pincells[group]['pwru310c00']['guidetube']['water1'])
geometry.addCell(pincells[group]['pwru310c00']['guidetube']['water2'])
geometry.addCell(pincells[group]['pwru310c00']['guidetube']['cladding'])
geometry.addCell(pincells[group]['pwru310c00']['instube']['cladding1'])
geometry.addCell(pincells[group]['pwru310c00']['instube']['helium'])
geometry.addCell(pincells[group]['pwru310c00']['instube']['cladding2'])
geometry.addCell(pincells[group]['pwru310c00']['instube']['water1'])
geometry.addCell(pincells[group]['pwru310c00']['instube']['water2'])
