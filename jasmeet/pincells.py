...
pincells['16fuel']['fuel'] = CellBasic(universe=0, material='d1') #initializes inner fuel cell
pincells['16fuel']['fuel'].addSurface(halfspace=-1, surface=surfaces['Fuel Radius-1'])  
pincells['16fuel']['clad'] = CellBasic(universe=1, material='d2') #initializes cladding cell
...
pincells['16fuel']['water'] = CellBasic(universe=2, material='d3') #initializes water cell
...
pincells['fuel'] = {} #dictionary of cells within this particular pin cell
pincells['24fuel']['fuel'] = CellBasic(universe=0, material='d1') #initializes inner fuel cell
pincells['24fuel']['fuel'].addSurface(halfspace=-1, surface=surfaces['Fuel Radius-1'])  
pincells['24fuel']['clad'] = CellBasic(universe=1, material='d2') #initializes cladding cell
...
pincells['24fuel']['water'] = CellBasic(universe=2, material='d3') #initializes water cell
