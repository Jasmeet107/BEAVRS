...
fullcorecell = CellFill(universe = universe_id(), universe_fill = fullcore.getId())
...
geometry.addCell(pincells['water'])
geometry.addCell(fullcorecell)
print 'INITIALIZED ALL CELLS'
