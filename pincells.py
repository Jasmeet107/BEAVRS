...
pincells['water'] = CellBasic(universe=pincells['water']['uid'], material= materials['2']['pwru160c00']['water'].getId())
...
for group in groups:
  ...
  pincells[group]['pwru160c00']['cladding'].addSurface(halfspace=+1, surface=surfaces['Fuel Radius-1']) #outside of innermost (1st) circle
  pincells[group]['pwru160c00']['cladding'].addSurface(halfspace=-1, surface=surfaces['Fuel Radius-2']) #inside of 2nd circle

  #WATER
  pincells[group]['pwru160c00']['water'] = CellBasic(universe=pincells[group]['pwru160c00']['uid'], material= materials[group]['pwru160c00']['water'].getId())
  pincells[group]['pwru160c00']['water'].addSurface(halfspace=+1, surface=surfaces['Fuel Radius-2']) #outside of 2nd circle
  pincells[group]['pwru160c00']['water'].addSurface(halfspace=-1, surface=surfaces['Fuel Radius-3']) #inside of 3rd circle
