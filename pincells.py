...
for group in groups:
	...
	for name in names: 
		...
		#HELIUM
		pincells[group][name]['helium'] = CellBasic(universe=pincells[group][name]['uid'], material= materials[group][name]['helium'].getId()) #initializes helium cell
		...
		#WATER
		pincells[group][name]['guidetube']['water1'] = CellBasic(universe=pincells[group][name]['guidetube']['uid'], material=materials[group][name]['water'].getId())
		...
		#WATER
		pincells[group][name]['guidetube']['water2'] = CellBasic(universe=pincells[group][name]['guidetube']['uid'], material= materials[group][name]['water'].getId()) #initializes water cell
		...
		#CLADDING
		pincells[group][name]['instube']['cladding1'] = CellBasic(universe=pincells[group][name]['instube']['uid'], material=materials[group][name]['cladding'].getId())
		...
		#WATER
		pincells[group][name]['instube']['water1'] = CellBasic(universe=pincells[group][name]['instube']['uid'], material=materials[group][name]['water'].getId())
	...
	#CLADDING
		pincells[group][name]['instube']['cladding2'] = CellBasic(universe=pincells[group][name]['instube']['uid'], material=materials[group][name]['cladding'].getId())
		...
		#WATER
		pincells[group][name]['instube']['water2'] = CellBasic(universe=pincells[group][name]['instube']['uid'], material= materials[group][name]['water'].getId()) #initializes water cell
	...
	for name in names:
		...
		#WATER
		pincells[group][name]['bp']['water1'] = CellBasic(universe=pincells[group][name]['bp']['uid'], material= materials[group][name]['water'].getId()) #initializes water cell
