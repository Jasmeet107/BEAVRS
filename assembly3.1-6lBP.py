...
assembly = CellFill(universe=0, universe_fill= lattices[group]['3.1-6lBP'].getId()) #create cell, fill with lattice
...
for material in materialtypes:
  geometry.addMaterial(materials[group]['pwru310w06'][material])
...
#add ALL cells
geometry.addCell(pincells[group]['pwru310w06']['fuel'])
geometry.addCell(pincells[group]['pwru310w06']['cladding'])
geometry.addCell(pincells[group]['pwru310w06']['water'])
geometry.addCell(pincells[group]['pwru310w06']['helium'])
geometry.addCell(pincells[group]['pwru310w06']['guidetube']['water1'])
geometry.addCell(pincells[group]['pwru310w06']['guidetube']['water2'])
geometry.addCell(pincells[group]['pwru310w06']['guidetube']['cladding'])
geometry.addCell(pincells[group]['pwru310w06']['instube']['cladding1'])
geometry.addCell(pincells[group]['pwru310w06']['instube']['helium'])
geometry.addCell(pincells[group]['pwru310w06']['instube']['cladding2'])
geometry.addCell(pincells[group]['pwru310w06']['instube']['water1'])
geometry.addCell(pincells[group]['pwru310w06']['instube']['water2'])
geometry.addCell(pincells[group]['pwru310w06']['bp']['helium'])
geometry.addCell(pincells[group]['pwru310w06']['bp']['ss'])
geometry.addCell(pincells[group]['pwru310w06']['bp']['helium1'])
geometry.addCell(pincells[group]['pwru310w06']['bp']['bg'])
geometry.addCell(pincells[group]['pwru310w06']['bp']['helium2'])
geometry.addCell(pincells[group]['pwru310w06']['bp']['ss1'])
geometry.addCell(pincells[group]['pwru310w06']['bp']['water'])
geometry.addCell(pincells[group]['pwru310w06']['bp']['cladding'])
geometry.addCell(pincells[group]['pwru310w06']['bp']['water1'])
