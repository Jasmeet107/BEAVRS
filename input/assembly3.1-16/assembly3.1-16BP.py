...
assembly = CellFill(universe=0, universe_fill= lattices[group]['3.1-16BP'].getId()) #create cell, fill with lattice
...
for material in materialtypes:
  geometry.addMaterial(materials[group]['pwru310w16'][material])
...
#add ALL cells
geometry.addCell(pincells[group]['pwru310w16']['fuel'])
geometry.addCell(pincells[group]['pwru310w16']['cladding'])
geometry.addCell(pincells[group]['pwru310w16']['water'])
geometry.addCell(pincells[group]['pwru310w16']['helium'])
geometry.addCell(pincells[group]['pwru310w16']['guidetube']['water1'])
geometry.addCell(pincells[group]['pwru310w16']['guidetube']['water2'])
geometry.addCell(pincells[group]['pwru310w16']['guidetube']['cladding'])
geometry.addCell(pincells[group]['pwru310w16']['instube']['cladding1'])
geometry.addCell(pincells[group]['pwru310w16']['instube']['helium'])
geometry.addCell(pincells[group]['pwru310w16']['instube']['cladding2'])
geometry.addCell(pincells[group]['pwru310w16']['instube']['water1'])
geometry.addCell(pincells[group]['pwru310w16']['instube']['water2'])
geometry.addCell(pincells[group]['pwru310w16']['bp']['helium'])
geometry.addCell(pincells[group]['pwru310w16']['bp']['ss'])
geometry.addCell(pincells[group]['pwru310w16']['bp']['helium1'])
geometry.addCell(pincells[group]['pwru310w16']['bp']['bg'])
geometry.addCell(pincells[group]['pwru310w16']['bp']['helium2'])
geometry.addCell(pincells[group]['pwru310w16']['bp']['ss1'])
geometry.addCell(pincells[group]['pwru310w16']['bp']['water'])
geometry.addCell(pincells[group]['pwru310w16']['bp']['cladding'])
geometry.addCell(pincells[group]['pwru310w16']['bp']['water1'])
